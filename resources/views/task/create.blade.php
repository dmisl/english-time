...
<x-form action="{{ route('task.store', [$course, $lesson]) }}" enctype="multipart/form-data">
    <div class="container" id="container">
        ...
        <h1 style="margin: 30px 0;">Task name</h1>
...
<script>
    ...
    function add_translation_f()
    {
        ...
        word.addEventListener('keyup', check_word)
        translate.addEventListener('keyup', check_translation)
...
{{-- <script>
    ...
    go.addEventListener('click', function () {
        if(task_type.value == 1)
        {
            container.innerHTML = `
                ...
                <div class="overview w-100 border rounded-5" style="padding-bottom: 100px;">
                    <div role="button" class="my-3 bg-success bg-gradient border" id="add_answers" >
                        <h2 class="mt-2">${tr_add_word_translations}</h2>
                    </div>
            ...
            scriptTranslation.setAttribute("src", scriptTranslationss);
