...
{{-- FIRST SLIDE --}}
<div class="container" style="font-family: 'Montserrat', sans-serif; padding-bottom: 15vh;">
    ...
    <div class="d-flex" style="text-align: left;">
        ...
        <div style="margin: 0 auto; margin-top: 13vh; width: 90%;">
            ...
            <h1 style="font-size: 9vw; font-weight: 500;">{{ __('main.online_school') }}</h1>
...
{{-- WHY US ANSWER --}}
<div style="font-family: 'Montserrat', sans-serif; width: 100%; background: linear-gradient(180deg, #F6F6F6 0%, #6385FF 0%); overflow: hidden; padding-top: 10px;">
...
{{-- FAQ --}}
<div style="width: 100%; background-color: #6385FF; padding-bottom: 10vh; font-family: Montserrat; color: white;">
    ...
    <div class="container">
        ...
        <p style="margin-top: 20px; font-weight: 400; font-size: 22px;">{{ __('main.where_classes_are_held') }}</p>
        <p style="font-size: 15px; font-weight: 300;">{{ __('main.you_study_individually_with_teacher') }}</p>

        <p style="font-size: 17px; font-weight: 400;">{{ __('main.what_does_this_site_provide') }}</p>
        <p style="font-size: 15px; font-weight: 300;">{{ __('main.this_is_website_with_all_materials') }}</p>

        <p style="font-size: 19px; font-weight: 400;">{{ __('main.duration_and_number_of_lessons') }}</p>
        <p style="font-size: 15px; font-weight: 300;">{{ __('main.the_duration_of_one_course_is') }}</p>

        <p style="font-size: 20px; font-weight: 400;">{{ __('main.payment_options') }}</p>
...
<div style="font-family: Montserrat; width: 100%; {{ is_dark() ? '' : 'background-color: #F6F6F6;'}} padding-bottom: 20vh;">
    ...
    <div class="container d-flex">
        ...
        <div class="course_includes_second">
            ...
            <p style="{{ is_dark() ? 'color: #212529;' : 'color: #F6F6F6;'}} font-size: 19px; padding: 0; margin: 0;">something</p>
...
{{-- FAQ --}}
<div style="font-family: Montserrat; width: 100%; background-color: #6385FF; padding-bottom: 10vh; color: white;">
