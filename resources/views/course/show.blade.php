...
<div class="container">
    ...
    <h1 class="p-0 m-0 py-4 pb-2" style="font-size: 55px;">{{ $course->name }}</h1>
        ...
        <div class="col-12 col-md-4 py-3" lesson_id="{{ $lesson->id }}">
            ...
            <x-card class="rounded-4">
                ...
                <x-card-body class="py-1 d-flex">
                    <div class="w-50">
                        <svg class="edit" lesson_id="{{ $lesson->id }}" role="button" style="margin-top: 2.5px;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="25" height="25" viewBox="0 0 256 256" xml:space="preserve">
                            <defs>
                            </defs>
                    ...
                    <div class="w-50">
                        <svg class="delete" lesson_id="{{ $lesson->id }}" role="button" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="27.5" height="27.5" viewBox="0 0 256 256" xml:space="preserve">
